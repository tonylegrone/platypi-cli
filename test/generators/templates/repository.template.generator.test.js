var chai = require('chai')
    ...
    , RepositoryGenerator = require('../../../platypi-cli/generators/templates/repository.template.generator')
...
describe('Repository Control template Generator', function () {
    describe('generate method, no extends', function () {
        var generator = new RepositoryGenerator('test', 'test', '');
        ...
        beforeEach(function (done) {
            ...
            sandbox.stub(CliConfig.config, 'getConfig', function () {
                return Promise.resolve({
                    templates: {
                        ...
                        controlLocation: {
                            repository: path.normalize('fake/location')
                        },
                        controls: {
                            base: {
                                repository: path.normalize('./fake/repository/location')
                            }
                        },
            ...
            sandbox.stub(fs, 'readdir', function (dirPath, callback) {
                if (dirPath === path.normalize("fake\\base\\location\\fake\\repository\\location\\topLevel")) {
                    callback(null, ['repository.mock.ts', 'repository.mock.d.ts']);
            ...
            sandbox.stub(fs, 'stat', function (statPath, callback) {
                callback(null, {
                    isDirectory: function () {
                        if (path.normalize(statPath) === path.normalize("fake\\base\\location\\fake\\repository\\location\\topLevel")) {
                            return true;
                        } else {
                            return false;
                        }
